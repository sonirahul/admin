...
htmlCreate : function () {	
	...
	/*<? endif ?>s*/ 
		this.innerContent = hs.getNode(this.contentId);
	if (!this.innerContent) 
		this.innerContent = hs.getSelfRendered();
		
	/*<? if ($cfg->templating) : ?>*/
	if (hs.useTemplating) this.innerContent = this.templateReplace(this.innerContent);
	/*<? endif ?>s*/
	/*<? if ($cfg->events) : ?>*/
