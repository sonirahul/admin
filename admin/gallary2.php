...
if($_POST["action"]=="beUpdate")//Applay Updates
{
	...
	echo "<script>document.location='index.php?model=gallary2';</script>";
}
//----------------------Add	
if($_POST["action"]=="Add")
{
...
<input type="hidden" name="previoustid"/>

<table border="0"width="100%" cellpadding="0" cellspacing="0">
<tr>
	  <TD  class="tit" align="center" colspan="2"><br />5th Anniversary</TD>
</tr>
<tr>
	  <td width="77%" align="left">&nbsp;</td>
	  <TD width="23%" align="center"><a href="index.php?model=gallary2&action=galleryadd" class="link">Add New 5th Anniversary</a></TD>
</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
				...
				<tr>
					<td colspan="2">
						...
						<tr align="center">
						<td><a href="index.php?model=gallary2&gid=<?=$SettingData[$i]["gallery_id"]?>&action=galleryupdate" class="link">Edit</a></td>
...
<input type="hidden"  name="gid" value="<?=$_GET["gid"]?>">
  <table width="80%" cellpadding="3" cellspacing="1" border="0" bgcolor="#526BB5" align="center">
            <tr><td colspan="2" height="15" bgcolor="#FFFFFF"></td></tr>
			<tr height="25" bgcolor="#FFFFFF"> 
              <td colspan="2" align="center">
			  <strong><? if ($_GET["action"]=="galleryupdate") echo "Edit 5th Anniversary Detail"; else echo "Add 5th Anniversary Detail ";?></strong>
			  </td>
            </tr>
            <tr height="25" bgcolor="#FFFFFF"> 
