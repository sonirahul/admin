        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea id="txtadesc" class="form-control col-md-7 col-xs-12 
                <?php 
                switch ($contentIDVar) {
                  case 3:
                  case 10:
                  case 11:
                  case 12:break;
                  default:echo "ckeditor"; break;
                }
                ?>


                "  name="txtadesc" cols="60" rows="15"><?php  echo $UpdatedData[0]['content_desc_ar'];?></textarea>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea id="txtedesc" class="form-control col-md-7 col-xs-12 
                ...
                "  name="txtedesc" cols="60" rows="15"><?php  echo $UpdatedData[0]['content_desc_en'];?></textarea>
              </div>
            </div>
