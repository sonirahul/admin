...
--
-- Host: localhost:3306
-- Generation Time: Aug 15, 2017 at 05:07 PM
...
(2, 'Singapore Airlines', 'Singapore Airlines', '<div id=\"sa-img\"><img src=\"images/others/sa.svg\" /></div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>?? ????? ???? ????? ?????? ????? ??? 1978 ? ??? ??? ????? ? ?? ???? ????? ??? ??????? ?????? ?????? ??????????? ????? ??????.<br />\r\n<br />\r\n???? ?????? ?????? ??????????? ? ?????? ???????? ???? ??? ????? ?? ???? ?? 700 ?????? ?????? ??? ?? ???? ?? 50 ???? ??? ???? ? ?????? ?????? ?????? ???????? ??? ????? 777- 300 ??? ??? ????? ????? ?????? ? ???? ??????? ? ???????? ???????? ? ????????. ???? ????????? ?? ???? ?????? ????? ??? ?????? ?????? ???????? / ???? ??? ??? ??? ???????? ??????? ?????? ???????????.<br />\r\n<br />\r\n????? ??????? ???????? ????? ? ???? ?? ???? ???? ?? ??????? ? ???????? ? ??????? ? ????????? ????????. ??? ????? ??????? ??????? ?? ????????? ??????? ?? ??????? ? ??????? ??? ??? ???????? ???? ?????? ??? ?? ??? ??? ???? . ????? ?????? ????????? ??? ???????? ???? ????? ??? ??? ??? ???????? ????????? ? ???????? ?? ??? ??? ???????? ? ????????? ??? ?????? ??? ?? ????????.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<div class=\"row text-center\" id=\"singapore-info\">\r\n<div class=\"col-md-4\">\r\n<p><br />\r\n<a href=\"http://www.singaporeair.com/kw\">www.singaporeair.com/kw</a></p>\r\n</div>\r\n\r\n<div class=\"col-md-4\" style=\"direction: ltr;\">\r\n<p><br />\r\n<a href=\"#\">(+965)&nbsp;</a>22971104</p>\r\n</div>\r\n\r\n<div class=\"col-md-4\" style=\"direction: ltr;\">\r\n<p><br />\r\n<a href=\"#\">(+965)&nbsp;</a>22495787</p>\r\n</div>\r\n</div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n', '<div id=\"sa-img\"><img src=\"images/others/sa.svg\" /></div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Al Rayes Travel Services was established in 1978 and since then representing as General Sales Agent for Singapore Airlines in Kuwait.<br />\r\n<br />\r\nSingapore Airlines and its regional carrier Silk Air serve over 700 weekly connections to more than 50 destinations across Asia Pacific besides daily 777-300 aircraft to Dubai with 4 cabins, First, Business, Premium Economy and Economy classes. Passengers from Kuwait can travel on Kuwait Airways/Fly Dubai to Dubai to connect Singapore Airlines.<br />\r\n<br />\r\nA city of diversity, Singapore is modern and dynamic with a unique mix of different races, cultures, foods and religions. The leisure traveler will be able to enjoy the array of activities and places to visit on this island, all year around, even if only on transit. Kuwaiti visitors can look forward to seamless connections to countries like Malaysia, Indonesia and Thailand, or even Australia and New Zealand after making stopover here in Singapore.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<div class=\"row text-center\" id=\"singapore-info\">\r\n<div class=\"col-md-4\">\r\n<p><br />\r\n<a href=\"http://www.singaporeair.com/kw\">www.singaporeair.com/kw</a></p>\r\n</div>\r\n\r\n<div class=\"col-md-4\">\r\n<p><br />\r\n<a href=\" (+965) 2225 8225\">(+965)&nbsp;</a>22971104</p>\r\n</div>\r\n\r\n<div class=\"col-md-4\">\r\n<p><br />\r\n<a href=\"http://www.singaporeair.com/kw\">(+965)&nbsp;</a>22495787</p>\r\n</div>\r\n</div>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n', NULL);
...
(4, 'Algeria', 'algeria.png', 0, '???????', 'countries_7.jpg', 1),
...
(114, 'Jordan', 'jordan.png', 0, '??????', 'countries_4.jpg', 1),
...
(150, 'Morocco', 'morocco.png', 1, '??????', 'countries_2.jpg', 1),
...
CREATE TABLE `countries_content` (
  `countries_content_id` int(11) NOT NULL,
  `countries_id` int(11) NOT NULL,
...
(11, '0', '???? ????? ????? ?????? ???? - ??????', 'Cyprus Visa Application Centre - Jordan ', '<p style=\"text-align:right\">???? ???? ????? ???? ???????? ?? VFS Global ?????? ???? ????? ????? ?????? ???? ?? ?????? ?????? 15 ?????? 2016<br />\r\n???? ?????? ?????? ????? ?????? ??? ???????? ??????? ???????? ?? ?????? ? ???? ?????? ????<br />\r\n?? ?????? ?????? ?? ??? ????? ?????? ??????? ?????? - ???? ???? ?? ??????</p>\r\n', '<p>Mawared House in collaboration with VFS &nbsp;Global announces the opening of the Cyprus&nbsp;Visa Application Centre in Jordan, On the 15th September 2016&nbsp;to cater the visa requirements of people residing in Jordan&nbsp;and planning to visit Cyprus.&nbsp;<br />\r\nThe centre was inaugurated by&nbsp;<strong>H. E. Nafsika Krousti&nbsp;-&nbsp;Ambassador of Cyprus&nbsp;to Jordan</strong>.</p>\r\n', 'news_11.jpg');
...
ALTER TABLE `countries`
  ...
  ADD UNIQUE KEY `countries_title_en_UNIQUE` (`countries_title_en`);

--
-- Indexes for table `countries_content`
--
ALTER TABLE `countries_content`
  ADD PRIMARY KEY (`countries_content_id`),
  ADD UNIQUE KEY `countries_content_id_UNIQUE` (`countries_content_id`);
...
ALTER TABLE `statistics`
  ...
  ADD UNIQUE KEY `idstatistics_id_UNIQUE` (`statistics_id`);
...
--
ALTER TABLE `countries_content`
  MODIFY `countries_content_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `statistics`
--
ALTER TABLE `statistics`
  MODIFY `statistics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
