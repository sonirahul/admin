<div class="maindata">
<div class="line"><h3>Feed Back  </h3></div>
...
<table cellpadding="0" cellspacing="0" width="500" border="0">
        ...
        <table width="100%">
        	<tr>
                <td style="font:Arial, Helvetica, sans-serif;  vertical-align:middle; padding-top:10; font-size:13px; text-align:left; height:40px; width:65px">Name:</td>
                <td><input id="name" name="name" style="color:#999" size="35" type="text" onFocus="clearName()" value="enter your name" /></td>
                <td width="100px"></td>
                <td style="font:Arial, Helvetica, sans-serif;  vertical-align:middle; font-size:13px; text-align:left; width:65px">E-mail:</td>
            ...
            <tr>
                <td style="font:Arial, Helvetica, sans-serif;  vertical-align:middle; padding-top:10; font-size:13px; text-align:left; height:40px; width:65px">Subject:</td>
                <td><input id="subject" name="subject" style="color:#999" size="35" type="text" value="enter subject" onFocus="clearSubject()" /></td>
                <td width="100px"></td>
                <td style="font:Arial, Helvetica, sans-serif;  vertical-align:middle; font-size:13px; text-align:left; width:65px">Mobile:</td>
                <td><input id="mobile" name="mobile" style="color:#999" size="35" type="text" value="enter your mobile" onFocus="clearMobile()" /></td>
            </tr>
            <tr>
                <td style="font:Arial, Helvetica, sans-serif;  vertical-align:top; font-size:13px; text-align:left; height:150px; width:65px; padding-top:10">Details:*</td>
