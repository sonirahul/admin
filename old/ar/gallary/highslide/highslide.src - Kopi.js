...
hs.Metrics = function(exp, dim) {
	...
	this.t = exp.el[this.wh] ? parseInt(exp.el[this.wh]) : el.exp['offset' +this.ucwh]; /// thumb width
	this.tpos = exp.tpos[dim]; /// thumb left
	this.tb = (exp.el['offset' +this.ucwh] - this.t) / 2; /// thumb border
	/*<? if ($cfg->overlays) : ?>s*/
